...
<body>
  ...
  <main id="main" class="main">
    ...
    <div align="center">
      ...
      <div style="font-size: 20px">
        SKIMP<br>
        Berufsschule Linz 2<br>
        Wiener Straße 181, <br>
        420 Linz, <br>
        Österreich<br>
        <hr>
        <u> Im Auftrag von:</u>
        <br> Strutzenberger Jürgen<br>
        <hr>
        <u> Unternehmensgegenstand:</u> <br> IT Dienstleistungen<br>
        <hr>
        <u> Kontakt Daten:</u>
        <br>
      ...
      Tel.:
      <a style="color: black;   text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="tel: +43 732 7720 35800">+43 732 7720 35800<br></a>
      Fax:
      <a style="color: black;   text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="fax: 01234/56789-0">01234/56789-0<br></a>
      E-Mail:
      <a style="color: black;   text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="mailto: bs-linz2.post@ooe.gv.at">bs-linz2.post@ooe.gv.at<br></a>
      <hr><br>
      <u>
        <h4>Mitglied bei: </h4>
      </u>
      Bildungsdirektion OÖ<br>
      Aufsichtsbehörde/Gewerbebehörde: Bezirkshauptmannschaft Linz<br>
      Verleihungsstaat: Österreich<br>
      <br>
      <hr><br>
      <h4> <u>Kontaktdaten des Verantwortlichen für Datenschutz:<br></u></h4>
      ...
      Der Datenschutzbeauftragte der Bildungsdirektion OÖ ist:<br>
      AD Edmund Hauswirth<br>
      E-Mail Adresse:
      <a style="color: black;   text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="mailto: datenschutz@bildung‐ooe.gv.at">datenschutz@bildung‐ooe.gv.at<br></a>
      <br>
      <hr>
      <u>
      ...
      <a style="color:black; text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=DE"><br>
        https://ec.europa.eu/consumers/<br>
        odr/main/index.cfm?event=main.home2.show&lng=DE</a> richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.
      <br>
      ...
      <br>
      <u>
        <h4>Die Bilderrechte liegen bei:</h4>
      </u>
      <br>
      <h3 style="font-size: 500%;"><b>SKIMP®</b></h3></u>
      <div id="daten"></div>
      <br>
      <br>
  </main>
  ...
  <div align="center">
    <main id="main" class="main">
      <div class="section-title1">
        <i>
          <h2 class="uber23">Datenschutzerklärung</h2>
        </i>
      </div>
      <br><br>
      <br>
      ...
      Wir haben diese Datenschutzerklärung (Fassung 07.06.2023-122521279) verfasst, um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU) 2016/679 und anwendbaren nationalen Gesetzen zu erklären, welche personenbezogenen Daten (kurz Daten) wir als Verantwortliche – und die von uns beauftragten Auftragsverarbeiter (z. B. Provider) – verarbeiten, zukünftig verarbeiten werden und welche rechtmäßigen Möglichkeiten Sie haben. Die verwendeten Begriffe sind geschlechtsneutral zu verstehen.
      ...
      <a style="color:black; text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679">
      ...
      <br>
      <u>
        <h4>Zusätzlich zu der EU-Verordnung gelten auch noch nationale Gesetze:</h4>
      </u>
      ...
      <br><br>
      AD Edmund Hauswirth <br><b>E-Mail:</b>
      <a style="color: black; text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="mailto:datenschutz@bildung‐ooe.gv.at">
        <b>datenschutz@bildung‐ooe.gv.at</b></a>
      <br><br>
      <br>
      <hr>
      <br>
      ...
      <a style="color:black; text-decoration: underline; -webkit-text-decoration-color: red;text-decoration-color: red;" href="https://www.dsb.gv.at/">https://www.dsb.gv.at/</a>

      finden. In Deutschland gibt es für jedes Bundesland einen Datenschutzbeauftragten. Für nähere Informationen können Sie sich an die Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI) wenden. Für unser Unternehmen ist die folgende lokale Datenschutzbehörde zuständig:
      <br><br>
      <br>
      <hr>
      <br>
      ...
      <br>
      Art. 6 Abs. 1 lit. a DSGVO (Einwilligung): Sie geben uns die Einwilligung Ihre Daten zu speichern und weiter für den Geschäftsfall betreffende Zwecke zu verwenden;<br>
      Art. 6 Abs. 1 lit. b DSGVO (Vertrag): Es besteht die Notwendigkeit für die Erfüllung eines Vertrags mit Ihnen oder einem Auftragsverarbeiter wie z. B. dem Telefonanbieter oder wir müssen die Daten für vorvertragliche Tätigkeiten, wie z. B. die Vorbereitung eines Angebots, verarbeiten;<br>
      Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen): Wir wollen Kundenanfragen und geschäftliche Kommunikation in einem professionellen Rahmen betreiben. Dazu sind gewisse technische Einrichtungen wie z. B. E-Mail-Programme, Exchange-Server und Mobilfunkbetreiber notwendig, um die Kommunikation effizient betreiben zu können.<br>
      <br><br>
      <br>
      <hr>
      <br>
      <u>
        <h4>Erklärung verwendeter Begriffe:</h4>
      </u>
      ...
      Erläuterung: <br>Personenbezogene Daten sind also all jene Daten, die Sie als Person identifizieren können. Das sind in der Regel Daten wie etwa:
      <br>
      Name<br>
      Adresse<br>
      E-Mail-Adresse<br>
      ...
      <hr>
      <br>
      <h3>Alle Texte sind urheberrechtlich geschützt.
        <br><br>
